;(function (window, document) {
  ...
  const pageModel = {
    ...
    mainSlide: {
      ...
      links: {
        ...
        linkedin: document.querySelector("#link-linkedin"),
      },
    },
    aboutSlide: {
        ...
        story: {
          ...
          content: {
            first: document.querySelectorAll(
              ".about-slide__story-paragraph"
            )[0],
            second: document.querySelectorAll(
              ".about-slide__story-paragraph"
            )[1],
          },
        },
  ...
  function setLocalization(localizaton) {
    getLocalizatonJson(localizaton).then((data) => fillContent(data))
  }
  ...
  async function getLocalizatonJson(language) {
    return fetch(`./json/content/${language}-content.json`).then((response) =>
      response.json()
    )
  }

  async function getLinksJson() {
    return fetch(`./json/links.json`).then((response) => response.json())
  }

  async function getCategories() {
    return getSitesJSON().then((sites) => {
  ...
  async function getSitesJSON() {
    return fetch(`./json/portfolio-sites.json`).then((response) =>
      response.json()
    )
  }

  async function setSites() {
    return getSitesJSON().then((data) => insertSites(data))
  }
  ...
  function setLinks() {
    getLinksJson().then((data) => fillLinks(data, getDOMLinks()))
  }
  ...
  function fillContent(localization) {
    ...
    function fillHeader() {
      pageModel.header.headerMenu.mainSlide.innerHTML =
        localization.slideNames.main
      pageModel.header.headerMenu.aboutSlide.innerHTML =
        localization.slideNames.about
      pageModel.header.headerMenu.portfolioSlide.innerHTML =
        localization.slideNames.portfolio
    }

    function fillMainSlide() {
      pageModel.mainSlide.bigHeading.innerHTML =
        localization.mainSlide.bigHeading
      pageModel.mainSlide.smallHeading.innerHTML =
        localization.mainSlide.smallHeading
    }
    ...
    function fillAboutSlide() {
      ...
      function fillBio() {
        pageModel.aboutSlide.shortInfo.age.heading.innerHTML =
          localization.aboutSlide.age + ":"
        pageModel.aboutSlide.shortInfo.age.value.innerHTML =
          ((new Date() - new Date(2002, 7, 14, 0, 0, 0, 0)) /
            (24 * 3600 * 365.25 * 1000)) |
          0

        pageModel.aboutSlide.shortInfo.location.heading.innerHTML =
          localization.aboutSlide.location.heading + ":"
        pageModel.aboutSlide.shortInfo.location.value.innerHTML =
          localization.aboutSlide.location.value

        pageModel.aboutSlide.shortInfo.education.heading.innerHTML =
          localization.aboutSlide.education.heading + ":"
        let educationLink = document.createElement("a")
        pageModel.aboutSlide.shortInfo.education.value.innerHTML =
          localization.aboutSlide.education.inProgress + ", "
        pageModel.aboutSlide.shortInfo.education.value.appendChild(
          educationLink
        )
      ...
      function fillSkills() {
        pageModel.aboutSlide.shortInfo.skills.html.name.innerHTML =
          localization.aboutSlide.skills.html.name
        pageModel.aboutSlide.shortInfo.skills.html.description.innerHTML =
          localization.aboutSlide.skills.html.description

        pageModel.aboutSlide.shortInfo.skills.css.name.innerHTML =
          localization.aboutSlide.skills.css.name
        pageModel.aboutSlide.shortInfo.skills.css.description.innerHTML =
          localization.aboutSlide.skills.css.description

        pageModel.aboutSlide.shortInfo.skills.js.name.innerHTML =
          localization.aboutSlide.skills.js.name
        pageModel.aboutSlide.shortInfo.skills.js.description.innerHTML =
          localization.aboutSlide.skills.js.description

        pageModel.aboutSlide.shortInfo.skills.wordpress.name.innerHTML =
          localization.aboutSlide.skills.wordpress.name
        pageModel.aboutSlide.shortInfo.skills.wordpress.description.innerHTML =
          localization.aboutSlide.skills.wordpress.description
      }

      function fillStory() {
        pageModel.aboutSlide.shortInfo.story.heading.innerHTML =
          localization.aboutSlide.story.heading
        pageModel.aboutSlide.shortInfo.story.content.first.innerHTML =
          localization.aboutSlide.story.content.first
        pageModel.aboutSlide.shortInfo.story.content.second.innerHTML =
          localization.aboutSlide.story.content.second
      }
    }
    function fillPortfolio() {
      ...
      sites.forEach((site) => {
        ...
        siteTypeElement.innerHTML =
          localization.portfolioSlide.categories[siteType]

        site.querySelector(".portfolio__item-validation").innerHTML =
          localization.portfolioSlide.site.validation
      })
